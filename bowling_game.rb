class BowlingGame
  ...
  # Returns true if current roll is strike, false if not.
  def strike?
    @roll == 10
  end
  ...
  # Returns true if current roll is spare, false if not.
  def spare?
    @roll + @next_roll == 10
  end
  ...
  # Adds both frames to score a normal non-spare and non-strike frame.
  #
  # Returns nothing.
  def score_norm
